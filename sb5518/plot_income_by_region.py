...
The purpose is to graphically explore the distribution of income.

Each boxplot and each histogram are saved in individual files.
"""
...
class graphical_explorer:
    def __init__(self, year):
        try:
            income_by_country_region = loaderandmerger.loader_merger_histogram.merge_by_year(year)
